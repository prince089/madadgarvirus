...
import 'package:madadgarvirus/user_screen/farmer/create_new_job/text_field.dart';
...
class DropDown<T> {
  ...
  final Function(List<DropDownItemModel>)? selectedItems;
...
class _MainBodyState extends State<MainBody> {
  ...
  List<DropDownItemModel> mainList = [];
                    ...
                    child: Align(
                      ...
                      child: Material(
                        child: ElevatedButton(
                          onPressed: () {
                            List<DropDownItemModel> selectedList = widget
                                .dropDown.data
